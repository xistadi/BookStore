...
urlpatterns = [
    ...
    path('delete_address/', views.DeleteProfileAddress.as_view(), name='delete_address'),
    path('update_address/<int:number>/', views.UpdateProfileAddress.as_view(), name='update_address'),
